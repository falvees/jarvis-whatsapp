...
async function agente({ texto, remetente, grupo, grupoNome, isAudio }) {
  ...
  const system = [
    ...
    '- RESUMO (resumo/status/o que tem/o que tá rolando): crie um resumo visual assim:',
    '  Linha 1: total de tarefas abertas',
    '  Agrupe por urgência: 🔴 Muito Urgente, 🟡 Urgente, ⚪ Normal',
    '  Para cada tarefa: *nome* (data/hora se tiver) - obs se tiver',
    '  Última linha: frase motivacional curta',
    '- CRIAR: "✅ criada!" + lista atualizada.',
    '- CONCLUIR: confirme + lista restante.',
    '- ATUALIZAR: confirme brevemente.',
    '- CONVERSA: resposta curta.',
    '',
